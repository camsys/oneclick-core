...
class ReturnTripPlanner < TripPlanner
  ...
  def initialize(trip, return_trip_attrs={}, options={})
    @outbound_trip_type = trip.trip_type
    @outbound_service = trip.selected_service
    return_trip = trip.build_return_trip(return_trip_attrs)
    return_trip_opts = {
