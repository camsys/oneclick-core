...
[
  {"name"=>"rabbittransit Standard Booking Window", "description"=>"Rabbittransit Default Booking Window", "minimum_days_notice"=>1, "maximum_days_notice"=>21, "minimum_notice_cutoff_hour"=>12}
].each do | config_data|
  agency_name = "rabbittransit"
  agency = Agency.find_by(name: agency_name)
